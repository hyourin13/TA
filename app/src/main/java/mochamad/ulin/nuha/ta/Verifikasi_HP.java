        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    // Invalid request
                    // [START_EXCLUDE]
                    mPhoneNumberField.setError("Nomer Telepon Salah");
                    // [END_EXCLUDE]
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(Verifikasi_HP.this, Password.class);
                            i.putExtra("mutiara", "mutiara");
                            startActivity(i);
                            finish();
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                // [START_EXCLUDE silent]
                                mVerificationField.setError("Kode Tidak Cocok");
                                // [END_EXCLUDE]
                            }
                            // [START_EXCLUDE silent]
                            // Update UI
        ...
        switch (view.getId()) {
            ...
            case R.id.button_verify_phone:
                ...
                if (TextUtils.isEmpty(code)) {
                    mVerificationField.setError("Kode Tidak Boleh Kosong");
                    return;
                }
