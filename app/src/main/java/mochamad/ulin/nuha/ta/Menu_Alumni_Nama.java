...
public class Menu_Alumni_Nama extends SwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(this, nama, Toast.LENGTH_SHORT).show();
        DATA_URL = con.URL+"tampil_lokasi_alumni_nama.php?nama="+nama;
       // Toast.makeText(this, DATA_URL, Toast.LENGTH_SHORT).show();
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                Toast.makeText(Menu_Alumni_Nama.this, coba, Toast.LENGTH_SHORT).show();
                // gridView.getAdapter().getItem(position);
                Intent i = new Intent(Menu_Alumni_Nama.this, Detail.class);
                i.putExtra("NIS", coba);
                startActivity(i);
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(DATA_URL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        dialog.dismiss();
                        Toast.makeText(Menu_Alumni_Nama.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }
        );
